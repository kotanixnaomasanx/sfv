...
<title>{html.escape(title)} — Setouchi Factory View</title>
{head_html}
<style>
.sfv-submax-width:900px;margin:0 auto;padding:120px 24px 80px
...
.sfv-card .bdpadding:16px 18px
.sfv-card .bd h3margin:0 0 6px;font-size:18px
.sfv-card .bd pmargin:0;color:var(--sfv-ink-soft,#6b6b66);font-size:14px;line-height:1.6
.sfv-tagdisplay:inline-block;font-size:12px;padding:2px 10px;border-radius:999px;background:var(--sfv-tint,#eef5fa);color:var(--sfv-blue-deep,#2f8fc6);margin-bottom:8px
.sfv-metafont-size:13px;color:var(--sfv-ink-soft,#6b6b66);margin-bottom:6px
.sfv-article :is(h2,h3,h4)margin-top:1.8em
.sfv-article imgmax-width:100%;border-radius:12px
...
.sfv-tag{display:inline-block;font-size:12px;padding:2px 10px;border-radius:999px;background:var(--sfv-tint,#eef5fa);color:var(--sfv-blue-deep,#2f8fc6);margin-bottom:8px}
